...
export const Card = ({ children, opened }: ICard) => {
  ...
  return (
    <div
      className={`rounded-sm text-black p-4 lg:p-6 pb-8 border-2 box-border relative hover:shadow-card cursor-pointer transition [overflow-anchor:none] duration-200 ease-in-out break-inside-avoid ${
        isOpened
